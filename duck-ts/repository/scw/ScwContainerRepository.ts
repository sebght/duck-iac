...
export class ScwContainerRepository {
  ...
  private LEGIT_EXTERNAL_PORTS: number[] = [80, 8080, 8081, 5678];

  public newContainer(name: string, image: string, port: number, publiclyExposed: boolean, envs?: { [key: string]: string }): void {
